          ...
          <div className="max-w-[1600px] mx-auto flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-3 min-w-0">
              <Link to="/" className="flex items-center gap-3 min-w-0" aria-label="Back to home">
                ...
                <h1 className="text-lg sm:text-xl font-bold tracking-tight text-gray-900 truncate">InkTrace</h1>
              </Link>
            </div>
            
            <div className="flex items-center gap-2 sm:gap-3 ml-auto flex-wrap justify-end">
              <Link to="/settings-guide" className="text-sm hidden sm:block text-gray-600 hover:text-indigo-600 transition-colors px-1">Guide</Link>
              <a href="/wiki/" className="text-sm hidden sm:block text-gray-600 hover:text-indigo-600 transition-colors px-1">Wiki</a>
              <button
